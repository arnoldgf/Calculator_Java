...
public class Calc {
    ...
    public String result(String exp) throws CalcException{
        ...
        if (expItems.size()!=3){
            throw new CalcException("ОШИБКА. Выражение должно иметь вид: \"Число_1 Операция Число_2\", разделенные пробелом...");
        }
        ...
        //результат для римских чисел должен быть не меньше 0
        if (!(res>0))
        {
            throw new CalcException("ОШИБКА. Результат вычисления должен быть не меньше 0");
        }
